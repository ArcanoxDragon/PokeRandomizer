...
namespace PokeRandomizer.Common.Structures.RomFS.PokemonInfo
{
	public abstract class PokemonInfo : IDataStructure
	{
		...
		public int[] Stats => new[] { HP, Attack, Defense, Speed, SpecialAttack, SpecialDefense };
		...
		public double HeightM  => Height / 100.0;
		public double WeightKg => Weight / 10.0;
		...
		public int      BaseStat      => HP + Attack + Defense + Speed + SpecialAttack + SpecialDefense;
		...
		public bool HasType(BasePokemonType type) => Types.Any(t => t == type.Id);
	}
}