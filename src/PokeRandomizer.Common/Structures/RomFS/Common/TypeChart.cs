namespace PokeRandomizer.Common.Structures.RomFS.Common
{
	public static class TypeChart
	{
		...
		private static readonly EffectivenessType[] EffectivenessTypes = {
			EffectivenessType.NoEffect, EffectivenessType.Unknown,         // unused
			EffectivenessType.NotVeryEffective, EffectivenessType.Unknown, // unused
			EffectivenessType.Normal, EffectivenessType.Unknown,           // unused
